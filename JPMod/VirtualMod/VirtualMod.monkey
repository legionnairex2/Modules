...
Global VR_Display:VirtualDisplay
...
Function SetVirtualDisplay:VirtualDisplay (width:Int = 640, height:Int = 480, zoom:Float = 1.0)
	VR_Display = New VirtualDisplay (width, height, zoom)
	Return VR_Display
End
...
Function UpdateVirtualDisplay (zoomborders:Bool = True, keepborders:Bool = True)
	VR_Display.UpdateVirtualDisplay zoomborders, keepborders
End
...
Function VMouseX:Float (limit:Bool = True)
	Return VR_Display.VMouseX (limit)
End

Function VMouseY:Float (limit:Bool = True)
	Return VR_Display.VMouseY (limit)
End

' Virtual display size...

Function VDeviceWidth:Float ()
	Return VR_Display.vwidth
End

Function VDeviceHeight:Float ()
	Return VR_Display.vheight
End
