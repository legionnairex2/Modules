...
function CreateLiteSpriteSheet(SpriteSheetBitmapData:Bitmap, numSpritesW:int = 8, numSpritesH:int = 8):LiteSpriteSheet{
	return new LiteSpriteSheet(SpriteSheetBitmapData.bitmapData, numSpritesW, numSpritesH);
}
