...
class LiteSpriteStage
{
    ...
    public function LiteSpriteStage(stage3D:Stage3D, rect:Rectangle)
    {
        _stage3D = stage3D;
...
function CreateSpriteStage(stage3D:Stage3D,rect:Rectangle):LiteSpriteStage{
	return new LiteSpriteStage(stage3D,rect);
}